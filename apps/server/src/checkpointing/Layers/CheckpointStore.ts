...
import { GitCommandError } from "@dh/contracts";
import { GitCore } from "../../git/Services/GitCore.ts";
import { CheckpointStore, type CheckpointStoreShape } from "../Services/CheckpointStore.ts";
import { CheckpointRef } from "@dh/contracts";
    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Design Harness",
          GIT_AUTHOR_EMAIL: "design-harness@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Design Harness",
          GIT_COMMITTER_EMAIL: "design-harness@users.noreply.github.com",
        };
