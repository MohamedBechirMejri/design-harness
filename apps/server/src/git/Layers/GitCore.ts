...
import { GitCommandError, type GitBranch } from "@dh/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@dh/shared/git";
...
import { decodeJsonResult } from "@dh/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `dh-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
