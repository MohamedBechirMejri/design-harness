...
export const COMPOSER_DRAFT_STORAGE_KEY = "dh:composer-drafts:v1";
...
function normalizePersistedDraftsByThreadId(
  ...
  for (const [threadKeyOrId, draftValue] of Object.entries(
    ...
    const interactionMode =
      draftCandidate.interactionMode === "default" || draftCandidate.interactionMode === "design"
      ...
      return {
        ...
        setInteractionMode: (threadRef, interactionMode) => {
          ...
          const nextInteractionMode =
            interactionMode === "default" || interactionMode === "design" ? interactionMode : null;
          set((state) => {
            const existing = state.draftsByThreadKey[threadKey];
