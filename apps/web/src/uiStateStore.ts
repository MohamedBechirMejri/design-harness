...
export const PERSISTED_STATE_KEY = "dh:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "dh:renderer-state:v8",
  "dh:renderer-state:v7",
  "dh:renderer-state:v6",
  "dh:renderer-state:v5",
  "dh:renderer-state:v4",
  "dh:renderer-state:v3",
