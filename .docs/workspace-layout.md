...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@dh/shared/git`, `@dh/shared/DrainableWorker`) — no barrel index.
